...
RUN apt-get -y update && env DEBIAN_FRONTEND="noninteractive" apt-get -y install --no-install-recommends \
    ...
    #
    ## vscode online 
    wget -qO "/tmp/vscode.deb" https://github.com/coder/code-server/releases/download/v4.4.0/code-server_4.4.0_amd64.deb; \
    dpkg -i /tmp/vscode.deb; \
    #
    ## rclone
    wget -qO "/tmp/rclone.deb" https://github.com/rclone/rclone/releases/download/v1.58.1/rclone-v1.58.1-linux-amd64.deb; \
